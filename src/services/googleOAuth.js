...
const oauth2Client = new google.auth.OAuth2(
  ...
  "https://admin.storeify.co/api/v1/auth/google/oauth2callback"
);
...
export const getAuthUrl = async () => {
  ...
  try {
    ...
    const googleAuthUrl = oauth2Client.generateAuthUrl({
      access_type: 'offline',
      scope: SCOPES,
      redirect_uri: process.env.REDIRECT_URI || "https://admin.storeify.co/api/v1/auth/google/oauth2callback", // Use environment variable for flexibility
